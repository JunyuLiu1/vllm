...
from .fp8e4m3_sm80 import f32_to_e4m3fn
...
def compress_norm_rope_store_triton(
    ...
    if head_dim == 512:
        ...
        kernel_kwargs = {
            ...
            "USE_RAW_FP8_BYTES": use_raw_fp8_bytes(),
        }
    elif use_fp4_cache:
        ...
        num_warps = 1
        kernel_kwargs = {"USE_RAW_FP8_BYTES": use_raw_fp8_bytes()}
...
def _fused_kv_compress_norm_rope_insert_sparse_attn(
    ...
    if USE_RAW_FP8_BYTES:
        x_uint8 = f32_to_e4m3fn(x_clamped)
    else:
