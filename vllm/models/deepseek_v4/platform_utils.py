...
_USE_RAW_FP8_BYTES: "bool | None" = None
...
def use_raw_fp8_bytes() -> bool:
    """Whether CUDA kernels require software E4M3FN conversion on SM8x."""
    global _USE_RAW_FP8_BYTES
    if _USE_RAW_FP8_BYTES is None:
        capability = (
            current_platform.get_device_capability()
            if current_platform.is_cuda()
            else None
        )
        _USE_RAW_FP8_BYTES = capability is not None and capability.major == 8
    return _USE_RAW_FP8_BYTES
